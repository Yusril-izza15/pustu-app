...
// Artisan: php artisan make:request UpdatePatientRequest
// Path: app/Http/Requests/UpdatePatientRequest.php
...
class UpdatePatientRequest extends FormRequest
{
    ...
    {
        return [
            // no_rekam_medis tidak bisa diubah (read-only setelah dibuat)
